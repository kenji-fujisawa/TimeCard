...
extension TimeCardSchema_v2_3 {
    ...
    class SystemUptimeRecord_v2_3 {
        ...
        class SleepRecord_v2_3 {
            ...
            init(start: Date, end: Date, parent: SystemUptimeRecord? = nil) {
                self.start = start
                self.end = end
                self.parent = parent
            }
        ...
        typealias SleepRecord = SleepRecord_v2_3
...
typealias SystemUptimeRecord = TimeCardSchema_v2_3.SystemUptimeRecord_v2_3
